  ...
  function () {
    function ValidateClientSideForm(form) {
      ...
      */
      ...
      this._errors = [];
      this.fields = _toConsumableArray(this._form.querySelectorAll("input:not([type='submit'])"));
    }
    ...
    _createClass(ValidateClientSideForm, [{
      ...
      value: function validate(field) {
        var value = field.value,
            type = field.type,
            name = field.name;
        if (value === "") return false;else if (name === "email" || type === "email") return this.validator[name].regex.test(value);else return this.validator[type].regex.test(value);
      }
    }, {
      key: "addValidation",
      ...
      value: function setAlert(field) {
        ...
        var message = "".concat(name === "email" ? this.validator[name].message : [field.labels[0].textContent, this.validator[type].message].join(" "));
        if (field.nextElementSibling.classList.contains("help")) field.nextElementSibling.textContent = message;
      ...
      value: function clearAlert(field) {
        ...
        if (field.nextElementSibling.classList.contains("help")) field.nextElementSibling.textContent = "";
      ...
      key: "resetForm",
      value: function resetForm(event) {
        var _this3 = this;

        event.target.reset();
        this.fields.forEach(function (field) {
          _this3.removeAlert(field.id);
      ...
      value: function handleFocus(_ref) {
        ...
        if (target.parentElement.classList.contains("input")) target.parentElement.classList.add("focused");
      }
    }, {
      key: "handleBlur",
      value: function handleBlur(_ref2) {
        var target = _ref2.target;
        if (target.parentElement.classList.contains("input")) if (target.value.length == 0) {
